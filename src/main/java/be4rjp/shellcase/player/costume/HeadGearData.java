...
public class HeadGearData {
    ...
    public void setHeadGear(ShellCasePlayer ShellCasePlayer){
        List<Gear> gearList = ShellCasePlayer.getGearList();
        gearList.clear();
        gearList.add(gear1);
        gearList.add(gear2);
        gearList.add(gear3);
        ...
        player.getInventory().setHelmet(this.getItemStack(ShellCasePlayer.getLang()));
    }
}
