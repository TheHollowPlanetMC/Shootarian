package be4rjp.shootarian.weapon.gun.ui;
...
public class ChargerUI {
    ...
    public static void loadAllUI() {
        ...
        Shootarian.getPlugin().getLogger().info("Loading ui...");
        File dir = new File("plugins/shellcase/ui");
    
        dir.getParentFile().mkdir();
        dir.mkdir();
        File[] files = dir.listFiles();
        if (files.length == 0) {
            Shootarian.getPlugin().saveResource("ui/charger_x3.yml", false);
            files = dir.listFiles();
        }
