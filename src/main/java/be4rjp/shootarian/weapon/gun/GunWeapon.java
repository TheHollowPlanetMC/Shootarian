...
public abstract class GunWeapon extends ShootarianWeapon {
    ...
    //射撃時に鳴らすサウンド
    protected ShootarianSound shootSound = new ShootarianSound(Sound.ENTITY_PIG_STEP, 0.3F, 1F);
    //武器のパッシブ効果
    ...
    /**
     * 射撃時に鳴らすサウンドを取得する
     * @return ShootarianSound
     */
    public ShootarianSound getShootSound() {return shootSound;}
    ...
    public void onLeftClick(ShootarianPlayer shootarianPlayer) {
        ...
        shootarianPlayer.switchADS((GunStatusData) gunStatusData);
    }
    ...
    public void loadData(YamlConfiguration yml){
        ...
        if(yml.contains("sound")) this.shootSound = ShootarianSound.getSoundByString(Objects.requireNonNull(yml.getString("sound")));
