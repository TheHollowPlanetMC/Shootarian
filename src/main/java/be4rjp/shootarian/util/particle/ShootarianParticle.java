...
public abstract class ShootarianParticle {
    ...
    protected ShootarianParticle(Particle particle, int count, double x_offset, double y_offset, double z_offset, double extra) {
